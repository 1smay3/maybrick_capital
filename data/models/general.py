...
class DataStore:
    ...
    def read_parquet(self, sub_directory:str, filename:str, engine="polars")->Optional[Union[pl.DataFrame, pd.DataFrame]]:
    ...
    def write_parquet(self, df:Union[pd.DataFrame, pl.DataFrame], sub_directory:str, filename:str, log:bool=True)->None:
        filepath = self._get_full_path(sub_directory, filename)
        try:
    ...
    def read(self, sub_directory:str, filename:str, engine:Optional[str]=None, parquet_suffix:Optional[str]=True)->Union[pl.DataFrame, pd.DataFrame]:
    ...
    def real_all_in_directory(self, sub_directory:str, parquet_suffix:Union[bool, str]=True)->Dict[str, Union[pl.DataFrame, pd.DataFrame]]:
        self.all_data = {}
